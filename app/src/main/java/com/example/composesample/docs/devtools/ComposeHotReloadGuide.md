...
- HotSwan 1.2.1은 Kotlin 2.3.0 이상 필요 → **프로젝트 Kotlin 2.3.20 적용 완료 (2026-04-13)**
- Gradle 플러그인 **프로젝트에 적용 완료**. IDE 플러그인만 별도 설치하면 사용 가능

## 설치 방법 (프로젝트에 Gradle 설정 적용 완료)
...
- **Kotlin 2.3.0 이상 필수** — 프로젝트 Kotlin 2.3.20 적용 완료
- **IDE와 Gradle 플러그인 버전이 반드시 일치**해야 함 (현재 Gradle 플러그인: 1.2.1)
