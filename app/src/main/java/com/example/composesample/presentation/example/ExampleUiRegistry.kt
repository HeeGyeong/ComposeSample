...
import com.example.composesample.presentation.example.component.architecture.pattern.error.SealedDomainErrorExampleUI
import com.example.composesample.presentation.example.component.ui.overlay.SpotlightOverlayExampleUI
...
import com.example.composesample.presentation.example.component.architecture.development.concurrency.StructuredConcurrencyGuardrailExampleUI
...
import com.example.composesample.util.ConstValue.StructuredConcurrencyGuardrailExample
...
import com.example.composesample.util.ConstValue.FlowOverflowExample
...
val exampleUiRegistry: Map<String, @Composable (onBackEvent: () -> Unit) -> Unit> = mapOf(
    ...
    StructuredConcurrencyGuardrailExample to { onBackEvent -> StructuredConcurrencyGuardrailExampleUI(onBackEvent) },
    ...
    FlowOverflowExample to { onBackEvent -> FlowOverflowExampleUI(onBackEvent) },
