...
- **최신 업데이트**
  - 2026.03: 신규 예제 추가 (MotionBlur, LargeContentViewer, LocalContextStrings, EmbeddedPicker Compose 통합, Rebound 리컴포지션 모니터링, Coroutine Flow Testing with Turbine, Compose Preview Internals, Remember Patterns, Startup Optimization 등)
...
### **ui** - UI 컴포넌트 & 레이아웃
**layout**:
- **animation**: Compose 애니메이션, Shared Element Transition
