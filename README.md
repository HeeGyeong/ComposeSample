...
- **최신 업데이트**
  - 2026.03: 신규 예제 추가 (MotionBlur, LargeContentViewer, LocalContextStrings, EmbeddedPicker Compose 통합, Rebound 리컴포지션 모니터링, Coroutine Flow Testing with Turbine, Compose Preview Internals, Remember Patterns, Startup Optimization, AnimatedContent 심화, Claude Code 활용 등)
...
- **claudecode**: Claude Code 활용 (CLAUDE.md / Memory / Hooks / Cursor 비교)
